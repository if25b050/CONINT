...
# Contributing to @if25b050/string-toolkit
...
1. **Clone the repository**:
   ```sh
   git clone https://github.com/if25b050/CONINT.git
   cd CONINT/string-toolkit
   ```
...
- **Commit Message Format**: Commit messages should be descriptive, e.g., `feat: add new string function` following the [Conventional Commits Specification](https://www.conventionalcommits.org/en). It is easy to follow if you are using the [semantic-git-commit-cli](https://www.npmjs.com/package/semantic-git-commit-cli)
